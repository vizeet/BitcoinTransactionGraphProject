...
block_db = plyvel.DB(os.path.join(blocks_path, 'index'), compression=None)
chainstate_db = plyvel.DB(os.path.join(bitcoin_path, 'chainstate'), compression=None)
txindex_db = plyvel.DB(os.path.join(bitcoin_path, 'indexes', 'txindex'), compression=None)
